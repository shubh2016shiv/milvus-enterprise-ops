...
async def retry_on_transient_error(
    ...
    **kwargs,
    ...
    last_error: TransientOperationError | None = None
    ...
    def decorator(func: Callable[..., Awaitable[T]]) -> Callable[..., Awaitable[T]]:
        ...
        async def wrapper(self, *args, **kwargs) -> T:
            ...
            if config is None:
                ...
                logger.warning(
                    f"{func.__name__} has no _config attribute, executing without transient retry"
                )
                return await func(self, *args, **kwargs)

            return await retry_on_transient_error(
                lambda: func(self, *args, **kwargs), config, operation_name
            )
