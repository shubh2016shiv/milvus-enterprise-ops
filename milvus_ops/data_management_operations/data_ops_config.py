...
class DataOperationConfig:
    ...
    default_operation_timeout: float | None = 30.0
    ...
    def validate_batch_size(self, batch_size: int | None) -> int:
        """
        ...
        if batch_size < self.min_batch_size:
            raise ValueError(f"Batch size {batch_size} is below minimum ({self.min_batch_size})")
