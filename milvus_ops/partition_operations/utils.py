...
class PartitionProgressTracker:
    ...
    def complete_operation(
        self, operation_id: str, success: bool = True, error: str = None
    ) -> None:
        """
    ...
    def get_active_operations(self) -> list[dict[str, Any]]:
        ...
        """
        return [op for op in self.operations.values() if op["status"] in ["started", "in_progress"]]
...
class PartitionTimer:
    ...
    def get_all_stats(self) -> dict[str, dict[str, float]]:
        ...
        """
        return {op_name: self.get_operation_stats(op_name) for op_name in self.operations}
