...
class RetryBudget:
    ...
    def get_metrics(self) -> dict[str, Any]:
        ...
        if len(self.attempts) > 0:
            self._metrics.current_success_rate = len(self.successes) / len(self.attempts)
    ...
    def __repr__(self) -> str:
        ...
        self._clean_old_entries()
        success_rate = len(self.successes) / len(self.attempts) if len(self.attempts) > 0 else 1.0
        return (
