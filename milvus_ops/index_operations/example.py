...
async def demonstrate_basic_index_creation(index_manager: IndexManager, collection_name: str):
...
async def demonstrate_custom_parameters(index_manager: IndexManager, collection_name: str):
...
async def demonstrate_progress_monitoring(index_manager: IndexManager, collection_name: str):
    ...
    try:
        ...
        logger.info("Index creation initiated, monitoring progress...")
...
async def demonstrate_index_describe(index_manager: IndexManager, collection_name: str):
...
async def demonstrate_list_indexes(index_manager: IndexManager, collection_name: str):
...
async def demonstrate_check_index(index_manager: IndexManager, collection_name: str):
...
async def demonstrate_drop_index(index_manager: IndexManager, collection_name: str):
...
async def main():
    ...
    try:
        ...
        logger.info(
            f"Configuration created: timeout={config.default_timeout}s, "
