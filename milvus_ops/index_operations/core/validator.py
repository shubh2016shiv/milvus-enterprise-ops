...
class IndexValidator:
    ...
    _METRIC_COMPATIBILITY: dict[IndexType, set[MetricType]] = {
        ...
        IndexType.SPARSE_INVERTED_INDEX: {
            MetricType.SPARSE_IP,
            MetricType.SPARSE_COSINE,
        },
        IndexType.ANNOY: {MetricType.L2, MetricType.IP, MetricType.COSINE},
    }
    ...
    def validate_index_params(
        ...
        dimension: int,
        params: dict[str, Any] | IndexParams | None = None,
        field_type: str | DataType | None = None,
    ) -> IndexParams:
        """
        ...
        if params is None:
            ...
            if params.index_type != index_type:
                raise IndexParameterError(
                    ...
                    index_type=str(index_type),
                    parameter_errors={
                        "index_type": f"Parameter mismatch: {params.index_type} != {index_type}"
                    },
                )
            return params
        else:
    ...
    def validate_metric_compatibility(self, index_type: IndexType, metric_type: MetricType) -> None:
        """
    ...
    def validate_field_type_compatibility(
        self, index_type: IndexType, field_type: DataType
    ) -> None:
        """
    ...
    def validate_dimension_compatibility(self, index_type: IndexType, dimension: int) -> None:
        """
    ...
    def optimize_parameters(
        self, index_type: IndexType, dimension: int, row_count: int | None = None
    ) -> IndexParams:
        """
