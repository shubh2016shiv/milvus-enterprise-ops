...
class IndexBuildTracker:
    ...
    def __init__(self, collection_name: str, field_name: str, total_rows: int | None = None):
        """
    ...
    def start_tracking(self) -> None:
        ...
        logger.debug(f"Started tracking index build for {self.collection_name}.{self.field_name}")
    ...
    def update_progress(
        ...
        if state is not None:
            ...
            if state == IndexState.FAILED and failed_reason:
                ...
                logger.info(f"Index build for {self.collection_name}.{self.field_name} completed")
    ...
    def estimate_completion_time(self) -> tuple[datetime | None, float | None]:
        """
...
class IndexBuildTrackerRegistry:
    ...
    def register_build(
        self, collection_name: str, field_name: str, total_rows: int | None = None
    ) -> IndexBuildTracker:
        """
    ...
    def get_tracker(self, collection_name: str, field_name: str) -> IndexBuildTracker | None:
        """
    ...
    def update_progress(self, collection_name: str, field_name: str, **kwargs) -> None:
        """
    ...
    def get_progress(self, collection_name: str, field_name: str) -> IndexBuildProgress | None:
        """
    ...
    def remove_tracker(self, collection_name: str, field_name: str) -> None:
        """
    ...
    def get_all_builds(self) -> list[IndexBuildProgress]:
        ...
        """
        return [tracker.get_current_progress() for tracker in self._trackers.values()]
