...
class BaseSearch(Generic[T], ABC):
    ...
    @abstractmethod
    async def search(self, collection_name: str, query: str, config: T) -> SearchResult:
        """
    ...
    async def _execute_search(
        self, collection_name: str, search_params: dict[str, Any], timeout: float
    ...
    def _perform_search(
        self, alias: str, collection_name: str, search_params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """
