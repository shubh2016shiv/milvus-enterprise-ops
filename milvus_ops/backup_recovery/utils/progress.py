...
from ..models.entities import BackupProgress, BackupState
...
class BackupProgressTracker:
    ...
    def __init__(self, backup_id: str, collection_name: str, total_bytes: int = 0):
        """
        ...
        self.last_speed_calc_time: datetime | None = None
    ...
    @property
    def average_speed_bps(self) -> float | None:
        """
    ...
    @property
    def average_speed_mbps(self) -> float | None:
        """
    ...
    def mark_complete(self, success: bool = True, error_message: str | None = None) -> None:
        """
...
class BackupProgressTrackerRegistry:
    ...
    def register_backup(
        self, backup_id: str, collection_name: str, total_bytes: int = 0
    ...
    def get_tracker(self, backup_id: str) -> BackupProgressTracker | None:
        """
...
_global_registry: BackupProgressTrackerRegistry | None = None
