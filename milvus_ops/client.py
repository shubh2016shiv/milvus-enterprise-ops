...
from milvus_ops_exceptions import ConfigurationError, ConnectionError
...
class MilvusClient:
    ...
    def __init__(self, config: MilvusSettings | str | Path | None = None):
        """
        ...
        if config is None:
            ...
            raise ConfigurationError(
                "Invalid configuration type. Expected MilvusSettings, str, Path, or None."
            )
    ...
    def _initialize_connection(self):
        ...
        try:
            ...
            raise ConnectionError(f"Failed to connect to Milvus server: {e}") from e
